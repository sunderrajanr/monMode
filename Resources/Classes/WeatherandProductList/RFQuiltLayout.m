...
//    NSLog(@"insets Top : %f, Bottom : %f, Left : %f, Right : %f",insets.top,insets.bottom,insets.left,insets.right);
//    NSLog(@"Frame Y : %f, Width : %f, X : %f, Height : %f",frame.origin.y,frame.size.width,frame.origin.x,frame.size.height);
    UICollectionViewLayoutAttributes* attributes = [UICollectionViewLayoutAttributes layoutAttributesForCellWithIndexPath:indexPath];
    attributes.frame = UIEdgeInsetsInsetRect(frame, insets);
//    NSLog(@"Attributes Frame Y : %f, Width : %f, X : %f, Height : %f",attributes.frame.origin.y,attributes.frame.size.width,attributes.frame.origin.x,attributes.frame.size.height);
    return attributes;
}
